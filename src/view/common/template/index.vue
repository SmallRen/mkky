    ...
    data () {
      return {
        ...
        columns: [
          ...
          { title: '模板ID', key: 'id', sortable: true },
          { title: '矿机类型', key: 'username', sortable: true },
          { title: '矿机封面图', key: 'age', sortable: true },
          { title: '矿机型号', key: 'age', sortable: true },
          { title: '网络地址', key: 'age', sortable: true },
          { title: 'IP地址', key: 'age', sortable: true },
